...
result_path = '/home/yuhang/Work/cs5330/results/cuckoo_hashing'

input_file_path_format = result_path + '/{0}'

input_file_list = [
    'cuckoo_hashing_simple_100000_0.01.res',
    'cuckoo_hashing_simple_1000000_0.01.res',
    'cuckoo_hashing_simple_10000000_0.01.res',
    'cuckoo_hashing_simple_100000000_0.01.res',
    'cuckoo_hashing_twisted_100000_0.01.res',
    'cuckoo_hashing_twisted_1000000_0.01.res',
    'cuckoo_hashing_twisted_10000000_0.01.res',
    'cuckoo_hashing_twisted_100000000_0.01.res',
    'cuckoo_hashing_double_100000_0.01.res',
    'cuckoo_hashing_double_1000000_0.01.res',
    'cuckoo_hashing_double_10000000_0.01.res',
    'cuckoo_hashing_double_100000000_0.01.res',
]

avg_insert_time = np.zeros(shape=(3, 4))
error_rate = np.zeros(shape=(3, 4))

for i, input_file in enumerate(input_file_list):
    input_file_path = input_file_path_format.format(input_file)
    app_idx = i // 4
    size_idx = i % 4
    avg_insert_time[app_idx][size_idx] = get_data(input_file_path, 0)
    error_rate[app_idx][size_idx] = get_data(input_file_path, 1)
