...
int main(int argc, char* argv[]){
    ...
    uint32_t* table1 = (uint32_t *)table_generate((4*256*32 + 32*(unsigned long long)(1<<29))*sizeof(uint32_t));
    uint32_t* table2 = (uint32_t *)table_generate((4*256*32 + 32*(unsigned long long)(1<<29))*sizeof(uint32_t));
#else
